 ...
 *     },
 * }
 * @psalm-type MdxHtmxConfig = array{
 *     htmx_only?: array{
 *         enabled?: bool|Param, // Enable or disable the #[HtmxOnly] attribute functionality // Default: true
 *         status_code?: int|Param, // HTTP status code to return for non-htmx requests (404, 403, 400) // Default: 404
 *         message?: scalar|null|Param, // Error message for non-htmx requests // Default: "Not Found"
 *     },
 *     default_view_data?: array{
 *         enabled?: bool|Param, // Add _htmx_result and _htmx_request variables to views // Default: true
 *     },
 *     response?: array{
 *         vary_header?: bool|Param, // Add "Vary: HX-Request" header to responses (important for caching) // Default: true
 *         strict_mode?: bool|Param, // Throw exception when HtmxResponse is returned for non-htmx request // Default: false
 *     },
 *     csrf?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         token_id?: scalar|null|Param, // CSRF token ID used for generation and validation // Default: "mdx-htmx"
 *         header_name?: scalar|null|Param, // HTTP header name for CSRF token // Default: "X-CSRF-Token"
 *         safe_methods?: list<scalar|null|Param>,
 *     },
 * }
